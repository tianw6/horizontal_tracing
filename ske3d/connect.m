function Img = connect(Img, Y0,X0,Y1,X1)
...
% cite as: 
% Kanchi (2020). Connect two pixels (https://www.mathworks.com/matlabcentral/fileexchange/4211-connect-two-pixels), MATLAB Central File Exchange. Retrieved June 3, 2020.
